        ...
        for (i = 0; i < ids.length; i++) {
            ...
            if (!isIE8) {
                if (i > 0) {
                    ...
                    if (typeof(options.gutterClickBox) === 'undefined') {
                        gutter[addEventListener]('mousedown', startDragging.bind(pair))
                        gutter[addEventListener]('touchstart', startDragging.bind(pair))

                    } else {
                        options.gutterClickBox[addEventListener]('mousedown', startDragging.bind(pair))
                        options.gutterClickBox[addEventListener]('touchstart', startDragging.bind(pair))
